...
CropEngineV1::CropEngineV1() : m_stagingTexture(nullptr) {
        // 1. D3D11 장치 생성
...
void CropEngineV1::changeCropColorType(){
...
void CropEngineV1::start(HWND hwnd){
        if (!IsWindow(hwnd)) {
...
void CropEngineV1::processFrame(winrt::Windows::Graphics::Capture::Direct3D11CaptureFrame const& frame){
...
POINT CropEngineV1::getCoordinateOffset(HWND hWnd) {
...
POINT CropEngineV1::getClientOffset(HWND hWnd) {
        RECT rectWindow;
